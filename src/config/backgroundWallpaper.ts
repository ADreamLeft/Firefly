...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/love/hero-desktop-1.png",
			"assets/images/love/hero-desktop-2.png",
			"assets/images/love/hero-desktop-3.png",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/love/hero-mobile-1.png",
			"assets/images/love/hero-mobile-2.png",
			"assets/images/love/hero-mobile-3.png",
		],
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
