...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://adreamleft.github.io",

	// 站点描述
	description: "一个用来记录恋爱日常、散步、约会和生活碎片的小站。",

	// 站点关键词
	keywords: ["恋爱日常", "生活记录", "相册", "日记", "Astro"],
	...
	favicon: [
		...
		{
			src: "/favicon/favicon-128.ico",
			sizes: "128x128",
		},
		{
			src: "/favicon/favicon-180.ico",
			sizes: "180x180",
		},
		{
			src: "/favicon/favicon-192.ico",
			sizes: "192x192",
		},
	],
